  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#111111]/15 bg-[#FFFFFF]/95 backdrop-blur-sm">
      <div className="border-b border-[#111111]/15 bg-[#111111] text-[#FFFFFF]">
        <div className="mono mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-x-4 gap-y-1 px-4 py-2 text-center text-[0.68rem] font-semibold uppercase tracking-[0.14em] sm:px-6 lg:justify-between lg:px-8">
      ...
      <nav
        ...
        className="mx-auto flex max-w-7xl flex-col items-center gap-4 px-4 py-4 text-center sm:px-6 lg:flex-row lg:justify-between lg:px-8"
      >
